...
<body>
    ...
    <div class="container">
        <div class="card mb-5">
            <h5 class="card-header">Pay with Momo</h5>
            <div class="card-body">
                <form action="{{ route('checkouts.store') }}" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Enter your number</label>
                    ...
                    <button type="submit" style="padding:6px 6px 6px 10px;color:#212529;background:#d3dff0;border-radius:5px;">Buy Now</button>
                </form>
            </div>
        </div>
    </div>
